...
void usage()
{
    std::puts(
        ...
        "quit; Tab the other panel, Insert marks.  The programs - .SAV and\n"
        ".COM - are green; Enter runs one, but only in ms0515-cli, where a\n"
        "machine is.  Alt+F1 / Alt+F2 (or F4) choose the left / right panel's\n"
        "disk: a mounted device, or another image picked from a host listing\n"
        "shown in that panel.\n"
        "\n"
