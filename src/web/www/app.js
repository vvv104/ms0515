...
function bindApi() {
  ...
  api = {
    ...
    diskBooted:  c("ms_disk_booted", "string", ["string", "number"]),
    diskKit:     c("ms_disk_kit", "string", ["string", "number"]),
    diskSystem:  c("ms_disk_system", "number", ["string", "number", "string", "number", "string"]),
