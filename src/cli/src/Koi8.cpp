/*
 * Koi8.cpp — UTF-8 → KOI-8R conversion for host stdin.
 *
 * KOI-8R table from RFC 1489.  Bytes 0x00–0x7F are ASCII (pass through);
 * bytes 0x80–0xFF map to specific Cyrillic / box-drawing code-points,
 * stored here as raw code-points so the decoder builds a reverse map
 * once on first use.
 */
