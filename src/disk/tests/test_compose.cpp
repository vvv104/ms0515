...
std::vector<uint8_t> handler(uint8_t fill)
{
...
/* An exemplar: the kit on the boot volume of the media asked, bootable. */
std::vector<uint8_t> exemplar(Media media)
{
...
const std::vector<std::string> kKit{"SWAP.SYS", "RT11SJ.SYS", "DV.SYS", "DZ.SYS", "TT.SYS", "PIP.SAV", "START.COM"};
