...
void usage()
{
    std::puts(
        ...
        "view, F4 the disks (choose a device, mount an image), F5 copy, F6\n"
        "rename / move, F7 squeeze, F8 delete, F9 init, F10 quit; Tab the other\n"
        "panel, Insert marks, Enter views.\n"
        "\n"
